...
const translations = {
  es: {
    ...
    "about.summary": "Soy Miguel Ángel Mendoza Jaramillo, estudiante de Ingeniería de Software en la Universidad Cooperativa de Colombia, apasionado por el desarrollo web y la creación de soluciones tecnológicas innovadoras. Trabajo con tecnologías como Java, Python, JavaScript, Next.js y Git, aplicándolas en proyectos académicos enfocados en aplicaciones web, estructuras de datos y soluciones interactivas, lo que me ha permitido fortalecer mi lógica de programación y capacidad de resolución de problemas. Me destaco por mi trabajo en equipo, organización y disposición para asumir roles de liderazgo en proyectos grupales. Mi enfoque principal es el desarrollo frontend con UX/UI, creando interfaces atractivas y funcionales que mejoren la experiencia del usuario. También me interesa el desarrollo de videojuegos, un campo que me motiva y en el que estoy abierto a seguir aprendiendo. Actualmente busco oportunidades de prácticas para aplicar mis conocimientos en entornos reales y crecer profesionalmente como desarrollador.",
    ...
    "contact.form.error": "Hubo un error al enviar. Intenta de nuevo.",
    ...
    "skills.subtitle": "Nivel de dominio en cada tecnología",
    "skills.java": "Java",
    ...
    "skills.java_spring": "Spring Boot",
  ...
  en: {
    ...
    "about.summary": "I am Miguel Ángel Mendoza Jaramillo, a Software Engineering student at Universidad Cooperativa de Colombia, passionate about web development and creating innovative technological solutions. I work with technologies like Java, Python, JavaScript, Next.js and Git, applying them in academic projects focused on web applications, data structures and interactive solutions, which has allowed me to strengthen my programming logic and problem-solving skills. I stand out for my teamwork, organization and willingness to take on leadership roles in group projects. My main focus is frontend development with UX/UI, creating attractive and functional interfaces that improve user experience. I am also interested in game development, a field that motivates me and in which I am open to keep learning. I am currently looking for internship opportunities to apply my knowledge in real environments and grow professionally as a developer.",
    ...
    "contact.form.success": "Message sent successfully! I will respond soon.",
    ...
    "skills.subtitle": "Proficiency level in each technology",
    "skills.java": "Java",
    "skills.python": "Python",
    "skills.javascript": "JavaScript",
    "skills.typescript": "TypeScript",
