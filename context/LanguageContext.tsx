...
const translations = {
  es: {
    ...
    "about.summary": "Soy Miguel Ángel Mendoza Jaramillo, estudiante de Ingeniería de Software apasionado por el desarrollo web. Trabajo con tecnologías como Java, Python, JavaScript, Next.js y Git, aplicándolas en proyectos académicos de aplicaciones web y estructuras de datos. Me destaco por mi trabajo en equipo, organización y capacidad de resolución de problemas. Mi enfoque principal es el desarrollo frontend con UX/UI, y también me interesa el mundo de los videojuegos. Busco oportunidades de prácticas para crecer profesionalmente y seguir evolucionando tanto técnica como personalmente.",
  ...
  en: {
    ...
    "about.summary": "I am Miguel Ángel Mendoza Jaramillo, a Software Engineering student passionate about web development. I work with technologies like Java, Python, JavaScript, Next.js and Git, applying them in academic projects focused on web applications and data structures. I stand out for my teamwork, organization and problem-solving skills. My main focus is frontend development with UX/UI, and I am also interested in game development. I am looking for internship opportunities to grow professionally and keep evolving both technically and personally.",
