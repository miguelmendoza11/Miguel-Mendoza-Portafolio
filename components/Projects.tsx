...
const projects = [
  { titleKey: "projects.p1.title", descKey: "projects.p1.desc", github: "https://github.com/seba4s/ONE-GAME" },
  { titleKey: "projects.p2.title", descKey: "projects.p2.desc", github: "https://github.com/migueltovarb/ISWDISENO202502-1Miguelmendoza11" },
  { titleKey: "projects.p3.title", descKey: "projects.p3.desc", github: "https://github.com/miguelmendoza11/landinpage-proyecto" },
];
    ...
    <section id="projects" className="bg-white px-4 xs:px-5 sm:px-8 md:px-12 lg:px-20 xl:px-24 py-8 xs:py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
        {projects.map((project) => (
          <div key={project.titleKey} className="border border-gray-200 rounded-2xl p-4 xs:p-5 md:p-6 flex flex-col gap-4 shadow-sm">
